...
func extractFromFields(source map[string]stdjson.RawMessage, resourceAttributes pcommon.Map, logRecord plog.LogRecord, attributes pcommon.Map, extractFns map[string]extractFn, options Options) {
...
func setBodyFromText(logRecord plog.LogRecord, value stdjson.RawMessage) error {
...
func handleTextPayload(_ pcommon.Map, logRecord plog.LogRecord, _ pcommon.Map, _ string, value stdjson.RawMessage, _ Options) error {
	return setBodyFromText(logRecord, value)
}
...
func handleJSONPayload(_ pcommon.Map, logRecord plog.LogRecord, _ pcommon.Map, _ string, value stdjson.RawMessage, options Options) error {
	switch options.handleJSONPayload {
	case handleAsJSON:
...
func handleProtoPayload(_ pcommon.Map, logRecord plog.LogRecord, _ pcommon.Map, _ string, value stdjson.RawMessage, options Options) error {
	switch options.handleProtoPayload {
	case handleAsJSON:
		return setBodyFromJSON(logRecord, value)
	case handleAsProto:
...
func TranslateLogEntry(data []byte, options Options) (pcommon.Resource, plog.LogRecord, error) {
	...
	extractFromFields(src, resAttrs, lr, attrs, extractFns, options)
